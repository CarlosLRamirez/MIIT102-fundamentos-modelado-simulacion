...
### Tareas
1. Investiga en la documentación de `PingApp` cómo modificar el tamaño de los paquetes transmitidos (`packetSize` o algún parámetro relacionado).
...
7. Prepara un informe que incluya:
	- Descripción del proceso que seguiste para modificar el parámetro `packetSize`.
...
1. ¿Cómo supiste que el parámetro `packetSize` era el que debías modificar? ¿Qué pasos seguiste para encontrarlo?
